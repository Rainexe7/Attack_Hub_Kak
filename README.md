...
_G.A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync
_G.B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
...
if _G.Koben_Ham_Dam == true then
            while _G.Koben_Ham_Dam do wait()
		...
		function sections:CraftPage(Name,side)
			...
			function functionitem:Toggle(Name, default, callback)
				...
				TextButton.MouseButton1Click:Connect(function()
					if Tgo == false then
						Tgo = true
						MainToggle_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
